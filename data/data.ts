...
export const Features_Section_one = [
  {
    id: "1",
    text: {
      heading: "Host immersive classes",
      list: [
  ...
  },
  {
    id: "3",
    text: {
      heading: "Sell beautiful ebooks",
      list: [
        "Intuitive ebook reader",
        "Unlimited students per book",
...
export const Features_Section_two = [
  {
    id: "1",
    text: {
      heading: "Accept payments globally",
      list: [
        "Instant sales with Klas pay",
  ...
  },
  {
    id: "2",
    text: {
      heading: "Manage everything",
      list: [
        "Track your enrollments and earnings",
        "View detailed student insights",
